...
public class LinkParser {
    ...
    private static final String REGEX_OWNER = "^https://github\\.com\\/([a-zA-Z0-9_-]+)\\/[a-zA-Z0-9_-]+\\/$";
    private static final String REGEX_REPO = "^https://github\\.com\\/[a-zA-Z0-9_-]+\\/([a-zA-Z0-9_-]+)\\/$";
